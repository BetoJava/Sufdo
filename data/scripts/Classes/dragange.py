...
class Dragange(p.Classes):
    
    def __init__(self, pseudo):
        
        p.Classes.__init__(self, "Dragange", 3)
        p.Personnage.__init__(self, pseudo, "Dragange", 1250, 16, 6, 3, 4, 6, 3, 'dragange')
        ...
        self.s1 = p.Sort(0, "Jugement dernier", 15, "100 DG", 6, 0, 2, zone_cible = 'cercle', taille_zone = 4, po_modifiable = True, dg_min = 98, dg_max = 103)
